...

{
	...
	# ========================================================================
	# Aktif sistem 6.18.9 kullanıyor, NVIDIA 590.48.01 ile uyumlu.
	# 6.19 kernel'da NVIDIA API kırılması var (folio_free, zone_device_page_init).
	# NVIDIA driver güncellenince linuxPackages_latest'e geri dönülebilir.
	...
	boot.extraModprobeConfig = ''
		...
		# Force disable asus-wmi (fake install)
		install asus-wmi /bin/true
